...
typedef struct {
	...
	test_common_options_t *common_options_ptr;
...
static int run_benchmarks(void *arg)
{
	...
	if (args->common_options_ptr->is_export) {
...
int main(int argc, char *argv[])
{
	...
	if (test_common_options(&common_options, __FILE__)) {
	...
	gbl_args->common_options_ptr = &common_options;
